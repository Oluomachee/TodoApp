  ...
  return (
    ...
    <div className='flex flex-col justify-center items-center w-full gap-16'>
      <div className='bg-black w-full h-36 pt-8 justify-content-center items-center flex flex-col gap-8'>
        ...
        <div className='flex w-xs md:w-xl p-1 gap-2 rounded-md items-center bg-grey'>
          ...
          <Button onClick={() => { handlesubmit() }} className='max-w-md max-w-xs bg-[#1E6F9F] h-12 cursor-pointer'>Add</Button>
        </div>
      </div>
      <div className='gap-8  w-xs md:w-xl ' >
        <div>
